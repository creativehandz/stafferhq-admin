    ...
    <AuthenticatedLayout>
        ...
        <div class="py-6 min-w-full flex justify-between gap-2">
            <div class="mb-6 flex-col gap-3">
                ...
                <div class="flex gap-3 py-5">
                    ...
                    <div class="flex">
                        ...
                        <p class="text-xs font-medium">{{ props.job.location }}</p>
                    </div>
                </div>
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="flex gap-2">
                                ...
                                <div class="flex flex-col gap-1">
                                    ...
                                    <p class="text-xs font-medium">
                                        I am looking for mix of experience and
                                        value
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="p-4 sm:p-6 xl:p-10">
                        <div class="flex justify-between">
                            <div class="flex-col space-y-2">
                                ...
                                <p>
                                    This lets talent knows that this job could
                                    become full time
                                </p>
                                <button
                                    class="font-medium text-primary border-b-2 border-blue-500 pb-1"
                                >
                                    Learn more
                                </button>
                            </div>
                ...
                >
                    <div class="p-4 sm:p-6 xl:p-10">
                        <div class="flex-col space-y-1">
                            ...
                            <p class="text-sm font-medium">Proposals: 0</p>
                            <p class="text-sm font-medium">
                                Last viewed by client: 0
                            </p>
                            <p class="text-sm font-medium">Interviewing: 0</p>
                            <p class="text-sm font-medium">Invites sent: 0</p>
                            <p class="text-sm font-medium">
                ...
                >
                    <div class="p-4 sm:p-6 xl:p-10">
                        <div class="flex-col space-y-1">
                            ...
                            <button
                                class="font-medium text-primary border-b-2 border-blue-500 pb-0"
                            >
                                Zoho CRM Expert
                            </button>
                        </div>
            ...
            <div class="mb-6 flex-col flex gap-3">
                <Link :href="route('job.showJobInProposal', { id: job.id })">
                <PrimaryButton>Apply Now</PrimaryButton>
                </Link>
                <PrimaryButton>Save Job</PrimaryButton>
                <button class="font-medium text-primary">
                ...
                <p class="text-sm font-medium">Payment method verified</p>
