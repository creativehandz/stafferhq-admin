            ...
            >
                ...
                >
                    <div class="hidden h-full flex-col xl:flex xl:w-1/4">
                        <div
                            class="sticky border-b border-stroke px-6 py-7.5 dark:border-strokedark"
                        >
                            <h3
                                class="text-lg font-medium text-black dark:text-white 2xl:text-xl"
                            >
                    ...
                    <div
                        class="flex h-full flex-col border-l border-stroke dark:border-strokedark xl:w-3/4"
                    >
                        <div
