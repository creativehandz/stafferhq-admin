    ...
    <AuthenticatedLayout>
        ...
        >
            <div class="mx-auto max-w-[410px]">
                <img
                    src="../../img/illustration/illustration-02.svg"
                    alt="illustration"
                />
                <div class="mt-7.5 text-center">
                    ...
                    >
                        Your Proposal Sent Successfully!
                    </h2>
                    <p class="font-medium">
                        Thank you so much for your message. We check proposals
                        frequently and will try our best to respond to your
                        inquiry.
                    </p>
                    <a
                        href="/"
