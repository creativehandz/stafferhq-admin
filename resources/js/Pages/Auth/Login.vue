...
<template>
    <AuthLayout>
        ...
        <DefaultAuthCard subtitle="Start for free" title="Sign In to StafferHQ">
            ...
            <div class="flex justify-between mt-4">
                ...
                <div class="mb-5 mt-6">
                    <input
                        type="submit"
                        value="Sign In"
                        class="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 font-medium text-white transition hover:bg-opacity-90" :class="{ 'opacity-25': form.processing }" :disabled="form.processing"
                    />
                </div>
