                    ...
                    <div v-if="activeTab === 'viewJobPost'">
                        ...
                        >
                            <div class="col-span-12 xl:col-span-8">
                                <div
                                    class="rounded-sm border-none border-stroke bg-white shadow-none dark:border-strokedark dark:bg-boxdark"
                                >
                                    <div class="">
                            ...
                            <div class="col-span-12 xl:col-span-4">
                                <div
                                    class="rounded-sm border-l border-stroke bg-white shadow-none dark:border-strokedark dark:bg-boxdark"
                                >
                                    <div
                                        class="p-4 sm:p-6 xl:p-10 flex-col flex gap-3"
                                    >
                                        <div
