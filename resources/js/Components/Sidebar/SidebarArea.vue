    ...
    menuGroups.value[0].menuItems = [
        ...
        },
        {
            icon: `<svg
                  ...
                  viewBox="0 0 18 19"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"><path d="M4 7a1 1 0 0 1 1-1h1a1 1 0 0 1 0 2H5a1 1 0 0 1-1-1zm5 0a1 1 0 0 1 1-1h9a1 1 0 1 1 0 2h-9a1 1 0 0 1-1-1zm-5 5a1 1 0 0 1 1-1h1a1 1 0 1 1 0 2H5a1 1 0 0 1-1-1zm5 0a1 1 0 0 1 1-1h9a1 1 0 1 1 0 2h-9a1 1 0 0 1-1-1zm-5 5a1 1 0 0 1 1-1h1a1 1 0 1 1 0 2H5a1 1 0 0 1-1-1zm5 0a1 1 0 0 1 1-1h9a1 1 0 1 1 0 2h-9a1 1 0 0 1-1-1z" fill=""/></svg>`,
    ...
    menuGroups.value[0].menuItems = [
        {
            ...
            route: "#",
            children: [
                { label: "Your Dashboard", route: "employer-dashboard" },
            ],
        },
        {
            icon: `<svg
        ...
        {
            icon: `<svg class="fill-current" fill="none" width="18" height="18" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
<title>report</title>
<path d="M6 11h4v17h-4v-17zM22 16v12h4v-12h-4zM14 28h4v-24h-4v24z"></path>
</svg>`,
            label: "Reports",
            route: "#",
            children: [{ label: "Weekly Summary", route: "talent" }],
        },
        {
    ...
    menuGroups.value[0].menuItems = [
        ...
        // },
        {
            icon: `<svg class="fill-current" fill="none" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <path d="M3 13h8V3H3v10zm10 8h8v-8h-8v8zM3 21h8v-6H3v6zM13 3v8h8V3h-8z" fill-rule="evenodd"/>
</svg>
`,
            label: "Dashboard",
            route: "/dashboard",
        ...
        //         },
        //         { label: "Contract History", route: "gigs-record" },
        ...
        {
            icon: `<svg class="fill-current" fill="none" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <path d="M3 3v18h18V3H3zm9 13h3v-7h-3v7zm-5 0h3V8H7v8zm10 0h3v-4h-3v4z" fill-rule="evenodd"/>
</svg>
`,
            label: "Analytics",
            route: "#",
