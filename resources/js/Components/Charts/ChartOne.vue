    ...
    <div class="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
      <div class="flex w-full flex-wrap gap-3 sm:gap-5">
        <div class="flex min-w-47.5">
          ...
          <div class="w-full">
            <p class="font-semibold text-primary">Your Profile Views</p>
            <p class="text-sm font-medium">12.04.2024 - 12.05.2024</p>
          </div>
        </div>
        <div class="flex min-w-47.5">
          <span
          ...
          <div class="w-full">
            <p class="font-semibold text-secondary">Total Visitors</p>
            <p class="text-sm font-medium">12.04.2024 - 12.05.2024</p>
          </div>
        </div>
      </div>
