...
import UserTwo from '../../img/user/user-02.png'
import UserThree from '../../img/user/user-03.png'
import UserFour from '../../img/user/user-04.png'
import UserFive from '../../img/user/user-05.png'
...
<template>
  ...
  >
    <h4 class="mb-6 px-7.5 text-xl font-semibold text-black dark:text-white">Notifications</h4>
