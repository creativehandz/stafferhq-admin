...
<template>
 ...
 <!-- <div v-if="props">
      <h1>{{ props.name }}</h1>
      <p><strong>Occupation:</strong> {{ props.occupation }}</p>
      <p><strong>About:</strong> {{ props.about }}</p>
      <p><strong>Phone:</strong> {{ props.phone }}</p>
      <p><strong>Email:</strong> {{ props.email }}</p>
      <p><strong>Social Links:</strong> {{ props.social_links }}</p>
      <p><strong>Age:</strong> {{ props.age }}</p>
      <p><strong>Citizen:</strong> {{ props.citizen }}</p>
      <p><strong>Address:</strong> {{ props.address }}</p>
      <p><strong>Favorite Quote:</strong> {{ props.favorate_quote }}</p>
      <p><strong>Expertise:</strong> {{ props.expertise }}</p>
  ...
  >
    ...
    <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
      ...
      >
        <div class="relative drop-shadow-2">
          <img src="../../img/user/user-06.png" alt="profile" />
          <label
            for="profile"
      ...
      <div class="mt-4">
        <h3 class="mb-1.5 text-2xl font-medium text-black dark:text-white">{{ props.name }}</h3>
        <p class="font-medium">{{props.occupation}}</p>
        <div
    ...
    <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
      ...
      <!-- Favorite Quote -->
      <div class="mt-6">
        <h4 class="mb-3.5 font-medium text-black dark:text-white">Favorite Quote</h4>
        <p class="text-sm font-normal">{{ props.favorate_quote }}</p>
      </div>
      <!-- Expertise -->
      <div class="mt-6">
        <h4 class="mb-3.5 font-medium text-black dark:text-white">Expertise</h4>
        <p class="text-sm font-normal">{{ props.expertise }}</p>
      </div>
      <!-- What I Do -->
      <div class="mt-6">
        <h4 class="mb-3.5 font-medium text-black dark:text-white">What I Do</h4>
        <!-- <ul>
          <li v-for="item in props.what_i_do" :key="item" class="text-sm font-normal">{{ item }}</li>
        </ul> -->
        Skillset will display here
      </div>
      <!-- Skills -->
      <div class="mt-6">
        <h4 class="mb-3.5 font-medium text-black dark:text-white">Skills</h4>
        <!-- <ul>
          <li v-for="skill in props.skills" :key="skill" class="text-sm font-normal">{{ skill }}</li>
        </ul> -->
        Skills will display here
      </div>
      <!-- Educations -->
      <div class="mt-6">
        <h4 class="mb-3.5 font-medium text-black dark:text-white">Education</h4>
        <!-- <ul>
          <li v-for="education in props.educations" :key="education" class="text-sm font-normal">{{ education }}</li>
        </ul> -->
        Education will display here
      </div>
      <!-- Experiences -->
      <div class="mt-6">
        <h4 class="mb-3.5 font-medium text-black dark:text-white">Experiences</h4>
        <!-- <ul>
          <li v-for="experience in props.experiences" :key="experience" class="text-sm font-normal">{{ experience }}</li>
        </ul> -->
        Experiences will display here
      </div>
      <!-- Projects -->
      <div class="mt-6">
        <h4 class="mb-3.5 font-medium text-black dark:text-white">Projects</h4>
        <!-- <ul>
          <li v-for="project in props.projects" :key="project" class="text-sm font-normal">{{ project }}</li>
        </ul> -->
        Project will display here
      </div>
    </div>
  </div>
  <div v-else>
