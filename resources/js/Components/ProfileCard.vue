...
onMounted(() => {
    ...
    if (props.social_links) {
        parsedSocialLinks.value = JSON.parse(props.social_links);
    }
    parsedWhatIDo.value = JSON.parse(props.what_i_do);
    parsedSkills.value = JSON.parse(props.skills);
    if (props.educations) {
        // Attempt to parse the JSON string
        parsedEducations.value = JSON.parse(props.educations);
    }
    if (props.experiences) {
        parsedExperiences.value = JSON.parse(props.experiences);
    }
    if (props.projects) {
        parsedProjects.value = JSON.parse(props.projects);
    }
});
    ...
    >
        ...
        <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div class="mt-6">
                ...
                <ul>
                    <li
                        v-for="item in parsedWhatIDo"
                        :key="item.skillset"
                        class="text-sm font-normal"
                    >
                        <p><strong>Skillset : </strong> {{ item.skillset }}</p>
            ...
            <div class="mt-6">
                ...
                <li
                    v-for="education in parsedEducations"
            ...
            <div class="mt-6">
                ...
                <li
                    v-for="experience in parsedExperiences"
            ...
            <div class="mt-6">
                ...
                <li
                    v-for="project in parsedProjects"
                    :key="project.title"
                    class="text-sm font-normal"
                >
